...
class ZFDebug_Controller_Plugin_Debug extends Zend_Controller_Plugin_Abstract
{
    ...
    <style type="text/css" media="screen">
        ...
        #ZFDebug #ZFDebug_info {height:32px;
                       display: flex;
                       overflow: auto;
                       flex-wrap: nowrap;
        ...
        #ZFDebug .ZFDebug_span {padding:0 15px; line-height:32px; display:block; float:left; white-space: nowrap}
